...
typedef NS_ENUM(NSUInteger, CPCPaymentCardReaderType) {
...
typedef NS_ENUM(NSUInteger, CPCPaymentCardEntryMethod) {
...
typedef NS_ENUM(NSUInteger, CPCPaymentCardCardholderVerificationMethod) {
...
typedef NS_ENUM(NSUInteger, CPCPaymentCardDisplayStyle) {
...
@property (nonatomic, copy, readonly) NSString *numberLastFour;
@property (nonatomic, assign, readonly) CPCCardBrand brand;
@property (nonatomic, copy) NSString *firstName;
@property (nonatomic, copy) NSString *lastName;
@property (nonatomic, copy) NSString *title;
@property (nonatomic, strong) NSDate *expiration;
@property (nonatomic, copy) NSString *verificationValue;
...
@property (nonatomic, copy) NSData *authorizationRequestData;
@property (nonatomic, copy) NSData *authorizationRequestKeyData;

@property (nonatomic, copy) NSData *authorizationResponseData;
@property (nonatomic, copy) NSData *captureRequestData;
...
- (instancetype)initWithBrand:(CPCCardBrand)brand cardNumberLastFour:(NSString *)numberLastFour;
...
- (instancetype)initWithBrand:(CPCCardBrand)brand cardNumberLastFour:(NSString *)numberLastFour readerType:(CPCPaymentCardReaderType)readerType entryMethod:(CPCPaymentCardEntryMethod)entryMethod;

@property (nonatomic, readonly) NSUInteger minimumValidNumberLength;

// Display and formatting.
@property (nonatomic, readonly) NSString *formattedNumber;
@property (nonatomic, readonly) NSString *formattedMaskedNumber;
...
@property (nonatomic, readonly) NSString *localizedBrandAndLastFour;

/// Returns a string like "American Express 1234".
- (NSString *)localizedBrandAndNumberDisplayStringWithStyle:(CPCPaymentCardDisplayStyle)displayStyle;
...
- (NSDictionary *)authorizeDictionary;
- (NSDictionary *)refundDictionary;
