...
typedef enum {
    CR_SECURE_TOUCH_MODE_FEATURE_RESULT_SUCCESS = 0,
...
typedef enum {
    CR_SECURE_TOUCH_KEEPALIVE_ERROR_EXPIRED = 0,
...
void cr_secure_touch_mode_pin_pad_is_hidden(cr_secure_touch_mode_feature_t *secure_touch_mode, crs_stm_hide_pin_pad_res_t *result);

cr_secure_touch_mode_feature_t *cr_secure_touch_mode_feature_alloc(void);
cr_secure_touch_mode_feature_result_t cr_secure_touch_mode_feature_free(cr_secure_touch_mode_feature_t *secure_touch_mode);
cr_secure_touch_mode_feature_result_t cr_secure_touch_mode_feature_init(cr_secure_touch_mode_feature_t *secure_touch_mode,
                                                                        struct cr_cardreader_t *cardreader,
                                                                        cr_secure_touch_mode_feature_event_api_t const *event_api);
cr_secure_touch_mode_feature_result_t cr_secure_touch_mode_feature_term(cr_secure_touch_mode_feature_t *secure_touch_mode);
