...
typedef enum {
    CR_SQUID_KEY_AGREE_FEATURE_RESULT_SUCCESS = 0,
...
typedef void (*cr_squid_key_agree_key_master_key_reset_request_cb_t)(void *context, const uint8_t *master_key_reset_request, const pb_size_t request_len);
...
cr_squid_key_agree_feature_result_t cr_squid_key_agree_feature_init(struct cr_squid_key_agree_feature_t *squid_key_agree,
...
cr_squid_key_agree_feature_result_t cr_squid_key_agree_feature_term(struct cr_squid_key_agree_feature_t *squid_key_agree);

// Frees the memory for a cr_squid_key_agree_feature_t. The cr_squid_key_agree_feature_t must have
// been previously terminated.
cr_squid_key_agree_feature_result_t cr_squid_key_agree_feature_free(struct cr_squid_key_agree_feature_t *squid_key_agree);
...
cr_squid_key_agree_feature_result_t cr_squid_key_agree_peripheral_master_key_get_status(struct cr_squid_key_agree_feature_t *squid_key_agree);
...
cr_squid_key_agree_feature_result_t cr_squid_key_agree_host_master_key_get_status(struct cr_squid_key_agree_feature_t *squid_key_agree);
...
cr_squid_key_agree_feature_result_t cr_squid_key_agree_peripheral_session_key_get_status(struct cr_squid_key_agree_feature_t *squid_key_agree);
...
cr_squid_key_agree_feature_result_t cr_squid_key_agree_host_session_key_get_status(struct cr_squid_key_agree_feature_t *squid_key_agree);
...
cr_squid_key_agree_feature_result_t cr_squid_key_agree_begin_master_key_establishment(struct cr_squid_key_agree_feature_t *squid_key_agree, bool establish_session_key_after);
...
cr_squid_key_agree_feature_result_t cr_squid_key_agree_begin_session_key_establishment(struct cr_squid_key_agree_feature_t *squid_key_agree);
...
cr_squid_key_agree_feature_result_t cr_squid_key_agree_prepare_peripheral_master_key_reset_request(struct cr_squid_key_agree_feature_t *squid_key_agree);

// Asks the reader to perform an actual reset of the master key, given authorization from factory-server in `reset_response`.
// A call will be made (asynchronously) cr_squid_key_agree_feature_event_api_t:on_do_master_key_reset
cr_squid_key_agree_feature_result_t cr_squid_key_agree_do_master_key_reset(struct cr_squid_key_agree_feature_t *squid_key_agree,
                                                                           uint8_t *reset_response, size_t reset_response_len);

// Begins the master key recovery state machine. This function will be called by the key-agree arbiter (`spe_info` today),
// when it detects that the SPE has stored a master key, but the host has not.
// A call will be made (asynchronously) to cr_squid_key_agree_feature_event_api_t::on_session_key_established or cr_squid_key_agree_feature_event_api_t::on_master_key_recovery_failed
cr_squid_key_agree_feature_result_t cr_squid_key_agree_begin_master_key_recovery(struct cr_squid_key_agree_feature_t *squid_key_agree);

// NOTE: This function should only be called for testing purposes.
// Attempts to clear the master key stored on the host. The host software (TrustZone) will not accept this command on production-fused
// devices.
cr_squid_key_agree_feature_result_t cr_squid_key_agree_host_master_key_reset(struct cr_squid_key_agree_feature_t *squid_key_agree);

cr_squid_key_agree_feature_result_t cr_squid_key_agree_send_session_keys(struct cr_squid_key_agree_feature_t *squid_key_agree,
