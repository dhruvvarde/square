...
typedef struct {
    ...
    void *context;
} cardreader_rpc_client_callback_api_t;
...
void cardreader_rpc_client_set_callback_api(cardreader_rpc_client_t *client, cardreader_rpc_client_callback_api_t const *callback_api);
