...
typedef enum 
{
    ...
    PROPRIETARY_TAG_C1                                 = 0xc1,
    PTAG_AID_ACTUAL_LEN                                = 0xc1,
    PROPRIETARY_TAG_C2                                 = 0xc2,
    PTAG_KERNEL_ID                                     = 0xc2,
    PROPRIETARY_TAG_C3                                 = 0xc3,
    PROPRIETARY_TAG_C4                                 = 0xc4,
    PROPRIETARY_TAG_C5                                 = 0xc5,
    PROPRIETARY_TAG_C6                                 = 0xc6,
    PROPRIETARY_TAG_C7                                 = 0xc7,
    PROPRIETARY_TAG_D7                                 = 0xd7,
