...
securesession_result_t securesession_host_initialize(
    securesession_host_context_handle_t context_handle,
    squareup_firmware_ritual_SecureSessionStatus const * status_msg,
    uint8_t *whitebox,
    uint8_t** securesession_init_ptr,
    size_t* outlen);
...
securesession_result_t securesession_host_approve(
    securesession_host_context_handle_t context_handle,
...
securesession_result_t securesession_host_handle_update_session_secret(securesession_host_context_handle_t context_handle, squareup_firmware_ritual_SecureSessionKeyUpdate const *key_update_msg);
