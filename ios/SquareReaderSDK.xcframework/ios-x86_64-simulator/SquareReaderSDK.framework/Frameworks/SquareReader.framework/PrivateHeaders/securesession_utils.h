...
securesession_result_t securesession_utils_msg_is_valid(
    uint8_t const *buf,
    size_t len,
    securesession_msg_type_e msg);

securesession_result_t securesession_utils_proto_is_valid(
    squareup_firmware_ritual_SecureSessionMsgHdr const *hdr,
