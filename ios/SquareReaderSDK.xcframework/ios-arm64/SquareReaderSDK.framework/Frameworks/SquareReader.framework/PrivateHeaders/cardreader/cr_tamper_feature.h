...
typedef void (*cr_tamper_status_cb_t)(void *context,
                                      struct cr_tamper_t *tamper,
                                      cr_tamper_status_t const unit_status);

typedef void (*cr_tamper_start_tamperscope_ack_cb_t)( void *context);
typedef void (*cr_tamper_tamperscope_data_cb_t)(void *context,
                                                void const *buf,
                                                size_t buf_len);

typedef void (*cr_tamper_num_events_cb_t)(void *context,
                                          uint32_t count);
