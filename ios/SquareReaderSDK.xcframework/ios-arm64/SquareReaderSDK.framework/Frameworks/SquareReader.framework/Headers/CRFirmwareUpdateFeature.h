...
/**
 Called when a manifest of file and versions has been received.
 @param fileVersions An array of CRFirmwareUpdateFeatureFileVersion objects that were received from the device.
 @param ksn The KSN from the device for the server to MAC the configs. May be NULL if the device does not have keys injected successfully.
 */
- (void)firmwareUpdate:(CRFirmwareUpdateFeature *)firmwareUpdateFeature receivedFileVersions:(NSArray *)fileVersions ksn:(NSData *)ksn;
...
/// [CRFirmwareUpdateDelegate firmwareManifestReceived] or [CRFirmwareUpdateDelegate firmwareUpdate:receivedFileVersions:]
