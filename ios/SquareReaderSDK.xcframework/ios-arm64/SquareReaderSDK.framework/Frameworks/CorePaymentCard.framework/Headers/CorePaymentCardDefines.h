...
typedef NS_ENUM(NSUInteger, CPCCardBrandStyle) {
...
typedef NS_ENUM(NSUInteger, CPCCardVerificationValueSide) {
    CPCCardVerificationValueSideBack = 0,
    CPCCardVerificationValueSideFront
};

typedef NS_ENUM(NSUInteger, CPCCardBrand) {
...
typedef NS_ENUM(NSUInteger, CPCFelicaCardBrand) {
